...
python output_result_tk/extract_caffe.py --model output_result_tk/lenet_train_test.prototxt --weights output_result_tk/lenet_solver_iter_5000.caffemodel --output output_result_tk/result --index 0
