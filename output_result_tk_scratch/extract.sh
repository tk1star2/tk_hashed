...
python output_result_tk_scratch/extract_caffe.py --model output_result_tk_scratch/lenet_train_test.prototxt --weights output_result_tk_scratch/lenet_solver_iter_2000.caffemodel --output output_result_tk_scratch/result --index 0
